...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto h-[80px] px-6 flex items-center">
        ...
        <div className="hidden md:flex mx-auto items-center gap-8">
          ...
          {navLinks.map((link) => (
            <NavLink
              key={link.name}
              to={link.path}
              className="text-gray-800 text-sm font-medium hover:text-orange-500 transition"
            >
              {link.name}
            </NavLink>
          ))}
          ...
          <NavLink
            to="/career"
            className="px-5 py-1.5 text-sm font-semibold text-orange-500 border-2 border-orange-500 rounded-full bg-white shadow-md hover:bg-orange-500 hover:text-white transition"
          >
            Career
          </NavLink>
        ...
        <NavLink
          to="/contact"
          className="hidden md:block px-5 py-1.5 border-2 border-orange-500 text-orange-500 rounded-full text-sm font-medium hover:bg-orange-500 hover:text-white transition"
        >
          Contact Us
        </NavLink>
