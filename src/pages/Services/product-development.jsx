...
import { FaCogs, FaRocket, FaPalette, FaChartLine } from "react-icons/fa";
  ...
  return (
    <div className="bg-gray-50 min-h-screen px-6 md:px-16 py-16">
      ...
      <div className="grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h1 className="text-4xl md:text-5xl font-bold mt-6 leading-tight text-gray-900">
            ...
            Scalable <span className="text-orange-500">Digital Products</span>
          </h1>

          <p className="text-gray-600 mt-6 leading-relaxed max-w-lg">
            We bridge the gap between vision and reality. Our expert team
            delivers end-to-end product solutions that dominate markets and
            delight users.
          </p>
        </div>
      ...
      <div className="mt-28 bg-orange-500 text-white rounded-3xl p-10 text-center">
        <h2 className="text-3xl font-bold">Ready to Build Your Product?</h2>

        <p className="mt-4 text-orange-100">
          Let’s transform your idea into a scalable, high-impact digital
          product.
        </p>
