        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="leading-relaxed text-gray-300">
                  Sathya Softech-in, First Floor, S Chandra Reddy Towers,
                  Hitech City Road Divert, Madhapur, Hyderabad, Telangana
                  500081.
                </span>
              </li>
            </ul>
          ...
          {/* <div>
            <h4 className="text-white font-semibold mb-6">
              Stay Ahead with Sathya softech.in
            </h4>

            <p className="text-sm text-gray-400 mb-4">
              Subscribe to receive updates and insights from our team.
            </p>

            <form className="flex items-center bg-white rounded-full overflow-hidden w-full">
              ...
              <button
                type="submit"
                className="bg-teal-600 hover:bg-teal-700 text-white px-6 py-3 text-sm font-medium whitespace-nowrap transition"
              >
                Submit
              </button>
