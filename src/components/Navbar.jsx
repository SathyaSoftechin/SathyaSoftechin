  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto h-[88px] px-6 flex items-center">
        ...
        <NavLink
          to="/contact"
          className="hidden md:block px-6 py-2 border border-orange-500 text-orange-500 rounded-full text-sm font-medium hover:bg-orange-500 hover:text-white transition"
        >
          Contact Us
        </NavLink>
