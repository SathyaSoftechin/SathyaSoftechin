...
import { useState } from "react";
import HeroBg from "../assets/images/career-hero.png";
...
const jobs = [
  {
    ...
    area: "Madhapur",
    description:
      "Designing and implementing user interfaces using HTML, CSS, and JavaScript frameworks like React or Angular. Building and maintaining server-side application logic and databases.",
  },
  {
    id: 2,
    ...
    area: "Madhapur",
    description:
      "Develop and maintain scalable front-end applications using React.js and modern JavaScript frameworks.",
  },
  {
    id: 3,
    ...
    area: "Madhapur",
    description:
      "Develop mobile applications using Flutter for Android and iOS platforms.",
  },
  {
    id: 4,
    title: "PHP Developer",
    ...
    area: "Madhapur",
    description:
      "Develop dynamic web applications using PHP, MySQL and modern frameworks.",
  },
  {
    id: 5,
...
const Career = () => {
  ...
  return (
    <main className="w-full">
      ...
      {/* JOB LIST + DETAILS */}
      <section className="max-w-7xl mx-auto px-6 py-14 grid lg:grid-cols-2 gap-8">
        ...
        <div className="border rounded-xl p-8 bg-gray-50">
          ...
          <p className="text-gray-600 mb-4">Full-time</p>

          <h4 className="font-semibold mb-2">Work Place Type</h4>
          <p className="text-gray-600 mb-4">Hybrid</p>
          ...
          <p className="text-gray-600 mb-6">Minimum 3 Years</p>
